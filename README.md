...
```sbt
libraryDependencies += "io.scalajs" %%% "complete-platform" % "0.4.0"
```
##### MEAN Stack bundle (Node, MongoDB and Express.js)

```sbt
libraryDependencies += "io.scalajs.npm" %%% "mean-stack" % "0.4.0"
```

##### Angular.js bundle (including all associated components)

```sbt
libraryDependencies += "io.scalajs" %%% "angularjs-bundle" % "0.4.0"
```
