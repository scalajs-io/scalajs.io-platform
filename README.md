...
```sbt
libraryDependencies += "io.scalajs" %%% "complete-platform" % "0.3.0.8"
```
##### MEAN Stack bundle (Node, MongoDB and Express.js)

```sbt
libraryDependencies += "io.scalajs.npm" %%% "mean-stack" % "0.3.0.8"
```

##### Angular.js bundle (including all associated components)

```sbt
libraryDependencies += "io.scalajs" %%% "angularjs-bundle" % "0.3.0.8"
```
